...
// $admin_email  = trim($_POST["anastasiya.kastsiukevich@gmail.com"]);
// $email_from  = trim($_POST["info@portfolio.ru"]); // после @ должен использоваться домен наш

$project_name = "Портфолио"
$admin_email  = "anastasiya.kastsiukevich@gmail.com"
$email_from  = "info@n86164.tmweb.ru/"
